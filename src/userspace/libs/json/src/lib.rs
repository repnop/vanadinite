...
macro_rules! derive {
    ($(#[$($attr:meta),+])? struct $name:ident { $($field:ident: $t:ty),+ $(,)? }) => {
        ...
        $crate::derive!(@deser struct $name { $($field: $t),+ });
        $crate::derive!(@ser struct $name { $($field: $t),+ });
    };

    (Serialize, $(#[$($attr:meta),+])? struct $name:ident { $($field:ident: $t:ty),+ $(,)? }) => {
        $(#[$($attr),+])?
        struct $name {
            $($field: $t),+
        }
    ...
    (Deserialize, $(#[$($attr:meta),+])? struct $name:ident { $($field:ident: $t:ty),+ $(,)? }) => {
        $(#[$($attr),+])?
        struct $name {
            $($field: $t),+
        }
    ...
    (@ser struct $name:ident { $($field:ident: $t:ty),+ $(,)? }) => {
